...
**Meetivo** is a fullstack web platform that improves access to healthcare by streamlining the doctor appointment booking process.
It supports three different user roles: patients, doctors, and administrators. Each with dedicated functionalities suited to their needs.
The application includes integrated online payment systems such as Stripe and Razorpay, ensuring smooth and secure transaction handling.
Developed with the MERN technology stack (MongoDB, Express.js, React, and Node.js),
Meetivo delivers a modern, intuitive, and efficient experience for both users seeking care and medical professionals providing it.
...
- Provides information about **Meetivo’s vision** and mission.
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/MustafaNova2/Meetivo.git
   ```
